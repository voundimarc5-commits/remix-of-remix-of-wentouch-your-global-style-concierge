        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h1 className="font-display text-3xl md:text-4xl lg:text-5xl font-medium mb-6 text-foreground">
              Marques pour <span className="text-gradient-gold">Homme</span>
            </h1>
            <p className="text-muted-foreground text-lg">
              Découvrez notre sélection de marques masculines accessibles via notre service de conciergerie.
            </p>
          </div>
